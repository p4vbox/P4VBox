...
set design nf_sume_sdnet1
set top nf_sume_sdnet1
set device xc7vx690t-3-ffg1761
set proj_dir ./ip_proj
set ip_version 1.00
set lib_name NetFPGA
set p4_switch_name $::env(P4_SWITCH)
...
#####################################
#read_verilog "./wrapper1/sdnet_to_sume.v"
read_verilog "./wrapper1/sume_to_sdnet.v"
read_verilog "./wrapper1/nf_sume_sdnet1.v"
read_verilog "./wrapper1/changeEndian.v"

## to compile SDNet 2016.3
#add_files -scan_for_includes ./SimpleSumeSwitch/axi_lite_ipif_v3_0b/

add_files -scan_for_includes ./${p4_switch_name}/
import_files -force

## to compile SDNet 2016.3
#set_property library axi_lite_ipif_v3_0b [get_files $proj_dir/nf_sume_sdnet1.srcs/sources_1/imports/nf_sume_sdnet1_ip/SimpleSumeSwitch/axi_lite_ipif_v3_0b/hdl/src/vhdl/address_decoder.vhd]
#set_property library axi_lite_ipif_v3_0b [get_files $proj_dir/nf_sume_sdnet1.srcs/sources_1/imports/nf_sume_sdnet1_ip/SimpleSumeSwitch/axi_lite_ipif_v3_0b/hdl/src/vhdl/axi_lite_ipif.vhd]
#set_property library axi_lite_ipif_v3_0b [get_files $proj_dir/nf_sume_sdnet1.srcs/sources_1/imports/nf_sume_sdnet1_ip/SimpleSumeSwitch/axi_lite_ipif_v3_0b/hdl/src/vhdl/ipif_pkg.vhd]
#set_property library axi_lite_ipif_v3_0b [get_files $proj_dir/nf_sume_sdnet1.srcs/sources_1/imports/nf_sume_sdnet1_ip/SimpleSumeSwitch/axi_lite_ipif_v3_0b/hdl/src/vhdl/pselect_f.vhd]
#set_property library axi_lite_ipif_v3_0b [get_files $proj_dir/nf_sume_sdnet1.srcs/sources_1/imports/nf_sume_sdnet1_ip/SimpleSumeSwitch/axi_lite_ipif_v3_0b/hdl/src/vhdl/slave_attachment.vhd]
