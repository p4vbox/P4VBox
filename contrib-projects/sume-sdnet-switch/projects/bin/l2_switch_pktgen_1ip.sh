...
# Fix files for run 1 P4 IP
cp -v ${P4_PROJECT_DIR}/testdata/gen_testdata_1ip.py ${P4_PROJECT_DIR}/testdata/gen_testdata_${P4_PROJECT_NAME}.py
# cp -v ${NF_DESIGN_DIR}/hw/hdl/nf_datapath_1ip_pktgenInOut.v ${NF_DESIGN_DIR}/hw/hdl/nf_datapath.v
cp -v ${NF_DESIGN_DIR}/hw/hdl/nf_datapath_1ip_pktgenOut.v ${NF_DESIGN_DIR}/hw/hdl/nf_datapath.v
cp -v ${NF_DESIGN_DIR}/hw/tcl/simple_sume_switch_1ip.tcl ${NF_DESIGN_DIR}/hw/tcl/simple_sume_switch.tcl
cp -v ${NF_DESIGN_DIR}/hw/tcl/simple_sume_switch_sim_1ip.tcl ${NF_DESIGN_DIR}/hw/tcl/simple_sume_switch_sim.tcl
cp -v ${P4_PROJECT_DIR}/pktgen_hdl/simple_pktgen.v ${NF_DESIGN_DIR}/hw/hdl/simple_pktgen.v
...
# echo ------------------- PROGRAMING FPGA ----------------------
# cd ${P4_PROJECT_BIN} && ./p4_program_switch.sh 2>&1 | tee -a ${P4_PROJECT_DIR}/log/log_6-program_switch.txt
