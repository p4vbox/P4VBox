...
#source ../hw/create_ip/nf_sume_sdnet1.tcl  # only need this if have sdnet_to_sume fifo in wrapper
...
#source ../hw/create_ip/nf_sume_sdnet3.tcl  # only need this if have sdnet_to_sume fifo in wrapper
create_ip -name nf_sume_sdnet3 -vendor NetFPGA -library NetFPGA -module_name nf_sume_sdnet3_ip
set_property generate_synth_checkpoint false [get_files nf_sume_sdnet3_ip.xci]
reset_target all [get_ips nf_sume_sdnet3_ip]
generate_target all [get_ips nf_sume_sdnet3_ip]
##
...
## MOD SAQUETTI
# set sdnet_ip top_tb/top_sim/nf_datapath_0/nf_sume_sdnet1_wrapper_1/inst/SimpleSumeSwitch_inst/
# add_wave_divider {SDNet Control Interface}
# add_wave top_tb/top_sim/nf_datapath_0/nf_sume_sdnet1_wrapper_1/inst/internal_rst_done -color yellow
...
#
# set nf_sume_sdnet1_ip top_tb/top_sim/nf_datapath_0/nf_sume_sdnet1_wrapper_1/inst/
# add_wave_divider {nf_sume_sdnet1 input interface}
# add_wave $sdnet_ip/clk_lookup_rst
# add_wave $sdnet_ip/clk_lookup
# add_wave $nf_sume_sdnet1_ip/s_axis_tdata -radix hex
# add_wave $nf_sume_sdnet1_ip/s_axis_tkeep -radix hex
# add_wave $nf_sume_sdnet1_ip/s_axis_tvalid
# add_wave $nf_sume_sdnet1_ip/s_axis_tready
# add_wave $nf_sume_sdnet1_ip/s_axis_tlast
#
# add_wave_divider {SDNet Tuple-In}
# add_wave $nf_sume_sdnet1_ip/sume_tuple_in_VALID
# add_wave $nf_sume_sdnet1_ip/s_axis_tuser -radix hex
# add_wave $nf_sume_sdnet1_ip/in_pkt_len
# add_wave $nf_sume_sdnet1_ip/in_src_port
# add_wave $nf_sume_sdnet1_ip/in_dst_port
#
# add_wave_divider {nf_sume_sdnet1 output interface}
# add_wave $sdnet_ip/clk_lookup_rst
# add_wave $sdnet_ip/clk_lookup
# add_wave $nf_sume_sdnet1_ip/m_axis_tdata -radix hex
# add_wave $nf_sume_sdnet1_ip/m_axis_tkeep -radix hex
# add_wave $nf_sume_sdnet1_ip/m_axis_tvalid
# add_wave $nf_sume_sdnet1_ip/m_axis_tready
# add_wave $nf_sume_sdnet1_ip/m_axis_tlast
#
# add_wave_divider {SDNet Tuple-Out}
# add_wave $nf_sume_sdnet1_ip/sume_tuple_out_VALID
# add_wave $nf_sume_sdnet1_ip/m_axis_tuser -radix hex
# add_wave $nf_sume_sdnet1_ip/out_pkt_len
# add_wave $nf_sume_sdnet1_ip/out_src_port
# add_wave $nf_sume_sdnet1_ip/out_dst_port
#
# set const_reg_ip /top_tb/top_sim/nf_datapath_0/nf_sume_sdnet1_wrapper_1/inst/SimpleSumeSwitch_inst/const_reg_rw_0/
...
## MOD SAQUETTI
open_wave_config {/root/bitbucket/reconfigurableswitch/projects/waveforms/sim_2ips_wave.wcfg}
##
