...
for i in range(NUM_PKTS):
    ...
    pkt_app = Ether(src=src_MAC_app, dst=dst_MAC_app) / Dot1Q(vlan=vlan_id, prio=vlan_prio) / IP(ttl=20, chksum=0x7ce7, src=src_IP, dst=dst_IP) / ICMP()
    ...
    pkt_exp = Ether(src=src_MAC_exp, dst=dst_MAC_exp) / Dot1Q(vlan=vlan_id, prio=vlan_prio) / IP(ttl=19, chksum=0x7ce7, src=src_IP, dst=dst_IP) / ICMP()
