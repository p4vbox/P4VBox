...
add_wave $vSwitch0_wrapper/m_axis_tready -into Output_VS_0 -color blue
...
add_wave $vSwitch0_wrapper/s_axis_tready -into Input_VS_0 -color purple
add_wave $vSwitch0_wrapper/s_axis_tlast -into Input_VS_0 -color purple
add_wave_virtual_bus Tuple-out_VS_0 -color blue
add_wave $vSwitch0_wrapper/sume_tuple_out_VALID -into Tuple-out_VS_0
add_wave $vSwitch0_wrapper/m_axis_tuser -into Tuple-out_VS_0
add_wave $vSwitch0_wrapper/out_pkt_len -into Tuple-out_VS_0
add_wave $vSwitch0_wrapper/out_src_port -into Tuple-out_VS_0
add_wave $vSwitch0_wrapper/out_dst_port -into Tuple-out_VS_0
add_wave_virtual_bus Tuple-In_VS_0 -color blue
add_wave $vSwitch0_wrapper/sume_tuple_in_VALID -into Tuple-In_VS_0
add_wave $vSwitch0_wrapper/s_axis_tuser -into Tuple-In_VS_0
add_wave $vSwitch0_wrapper/in_pkt_len -into Tuple-In_VS_0
add_wave $vSwitch0_wrapper/in_src_port -into Tuple-In_VS_0
add_wave $vSwitch0_wrapper/in_dst_port -into Tuple-In_VS_0
add_wave_virtual_bus Control_VS_0 -color yellow
add_wave $vSwitch0_ip/internal_rst_done -into Control_VS_0 -color pink
