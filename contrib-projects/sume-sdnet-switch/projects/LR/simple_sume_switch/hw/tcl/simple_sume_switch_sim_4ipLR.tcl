...
#source ../hw/create_ip/nf_sume_sdnet2.tcl  # only need this if have sdnet_to_sume fifo in wrapper
create_ip -name nf_sume_sdnet2 -vendor NetFPGA -library NetFPGA -module_name nf_sume_sdnet2_ip
set_property generate_synth_checkpoint false [get_files nf_sume_sdnet2_ip.xci]
reset_target all [get_ips nf_sume_sdnet2_ip]
generate_target all [get_ips nf_sume_sdnet2_ip]
...
#source ../hw/create_ip/nf_sume_sdnet4.tcl  # only need this if have sdnet_to_sume fifo in wrapper
create_ip -name nf_sume_sdnet4 -vendor NetFPGA -library NetFPGA -module_name nf_sume_sdnet4_ip
set_property generate_synth_checkpoint false [get_files nf_sume_sdnet4_ip.xci]
reset_target all [get_ips nf_sume_sdnet4_ip]
generate_target all [get_ips nf_sume_sdnet4_ip]
