...
#source ../hw/create_ip/nf_sume_sdnet0.tcl   # only need this if sdnet_to_sume has fifo in wrapper
...
#source ../hw/create_ip/nf_sume_sdnet2.tcl   # only need this if sdnet_to_sume has fifo in wrapper
...
#source ../hw/create_ip/nf_sume_sdnet3.tcl   # only need this if sdnet_to_sume has fifo in wrapper
...
#source ../hw/create_ip/nf_sume_sdnet4.tcl   # only need this if sdnet_to_sume has fifo in wrapper
