...
read_verilog "$::env(NF_DESIGN_DIR)/hw/hdl/simple_pktgen.v"
...
## MOD SAQUETTI
open_wave_config {/root/bitbucket/reconfigurable_switch_mateus/projects/waveforms/sim_top_level.wcfg}
