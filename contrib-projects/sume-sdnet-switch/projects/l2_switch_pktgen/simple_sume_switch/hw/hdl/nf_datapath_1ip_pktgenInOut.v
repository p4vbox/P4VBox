...
(
    ...
    input_arbiter_v1_0 (
      ...
      .m_axis_tdata (), // .m_axis_tdata (s_axis_ipi_tdata),
      .m_axis_tkeep (), // .m_axis_tkeep (s_axis_ipi_tkeep),
      .m_axis_tuser (), // .m_axis_tuser (s_axis_ipi_tkuser),
      .m_axis_tvalid(), // .m_axis_tvalid(s_axis_ipi_tvalid),
      .m_axis_tready(), // .m_axis_tready(s_axis_ipi_tready),
      .m_axis_tlast (), // .m_axis_tlast (s_axis_ipi_tlast),
    ...
    packet_generator_1 (
      ...
      .m_axis_0_tdata   (s_axis_ipi_tdata), // .m_axis_tdata (s_axis_ipi_tdata),
      .m_axis_0_tkeep   (s_axis_ipi_tkeep), // .m_axis_tkeep (s_axis_ipi_tkeep),
      .m_axis_0_tuser   (s_axis_ipi_tkuser), // .m_axis_tuser (s_axis_ipi_tkuser),
      .m_axis_0_tvalid  (s_axis_ipi_tvalid), // .m_axis_tvalid(s_axis_ipi_tvalid),
      .m_axis_0_tready  (s_axis_ipi_tready), // .m_axis_tready(s_axis_ipi_tready),
      .m_axis_0_tlast   (s_axis_ipi_tlast) // .m_axis_tlast (s_axis_ipi_tlast),
    );
    ...
    input_p4_interface_0 (
      ...
      // Slave Stream Ports (input_arbiter to IPI)
    ...
    bram_output_queues_1 (
      ...
      .m_axis_0_tdata (), // .m_axis_0_tdata (m_axis_0_tdata),
      .m_axis_0_tkeep (), // .m_axis_0_tkeep (m_axis_0_tkeep),
      .m_axis_0_tuser (), // .m_axis_0_tuser (m_axis_0_tuser),
      .m_axis_0_tvalid(), // .m_axis_0_tvalid(m_axis_0_tvalid),
      .m_axis_0_tready(), // .m_axis_0_tready(m_axis_0_tready),
      .m_axis_0_tlast (), // .m_axis_0_tlast (m_axis_0_tlast),
    ...
    packet_generator_0 (
      ...
      // Master Stream Ports (interface to nf_sume_sdnet_ips)
      .m_axis_0_tdata   (m_axis_0_tdata),   // .m_axis_0_tdata (m_axis_0_tdata),
      .m_axis_0_tkeep   (m_axis_0_tkeep),   // .m_axis_0_tkeep (m_axis_0_tkeep),
      .m_axis_0_tuser   (m_axis_0_tuser),   // .m_axis_0_tuser (m_axis_0_tuser),
      .m_axis_0_tvalid  (m_axis_0_tvalid),  // .m_axis_0_tvalid(m_axis_0_tvalid),
      .m_axis_0_tready  (m_axis_0_tready),   // .m_axis_0_tready(m_axis_0_tready),
      .m_axis_0_tlast   (m_axis_0_tlast)   // .m_axis_0_tlast (m_axis_0_tlast),
    );
