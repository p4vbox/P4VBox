...
ovs-ofctl add-flow br0 "in_port=3, actions=output:51" -O openflow13
ovs-ofctl add-flow br0 "in_port=51, actions=output:3" -O openflow13
ovs-ofctl add-flow br0 "in_port=4, actions=output:52" -O openflow13
ovs-ofctl add-flow br0 "in_port=52, actions=output:4" -O openflow13
