...
NIC_IFACE_H0 = "enp1s0np0"
NIC_IFACE_H1 = "enp1s0np1"
NIC_IFACE_H2 = "enp1s0np0"
NIC_IFACE_H3 = "enp1s0np1"
...
DESCRIPTION: Listen the ethrnet interface especificated by <eth_name> - only show the headers.\n
    <eth_names> : the name of the ethernet interface to listen
                  if eth_name is 0, 1, 2 or 3, this namber is replaced by NIC_IFACE, based in host number.
"""
